...
### **Securing the web through code and deep-diving to find impactful vulnerabilities.**

I am a **Professional Software Developer** and **Security Enthusiast**. I focus on building robust, scalable systems by day and deep-diving into web security by night—always learning and looking for vulnerabilities that have a real-world impact.

---

### 🛡️ Security Research Highlights
My research is a journey of continuous learning, focusing primarily on **Web Security** with a secondary interest in **Mobile Security**.
...
| **Workflow** | **Ubuntu** (CLI-heavy environment) |

---

### 📫 Connect with me
- 🌐 [poundxi.com](https://poundxi.com)
- 🐦 [Twitter/X @PoundXI](https://twitter.com/PoundXI)
